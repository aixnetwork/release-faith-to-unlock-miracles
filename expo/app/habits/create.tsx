  ...
  const handleCreateHabit = async () => {
    ...
    if (!user?.accessToken || !user?.id) {
      Toast.show({
        ...
        text2: 'You must be logged in to create a habit',
      });
      return;
    }
    ...
    try {
      ...
      const url = `${ENV.EXPO_PUBLIC_RORK_API_BASE_URL}/items/habits`;
      ...
      if (!response.ok) {
        ...
        Toast.show({
          ...
          text2: 'Failed to create habit. Please try again.',
        });
        return;
      }
      ...
      Toast.show({
        type: 'error',
        text1: 'Creation Failed',
        text2: 'An error occurred while creating the habit.',
      });
    } finally {
      setIsLoading(false);
    }
